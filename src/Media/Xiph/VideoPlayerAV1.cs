...
{
	public unsafe class VideoPlayerAV1 : BaseYUVPlayer, IVideoPlayerImpl
	{
...
#if NET46 || NET461 || NET462 || NET47 || NET471 || NET472 || NET48 || NET481 || NETCORE
